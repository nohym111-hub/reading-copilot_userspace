...
2. **Work**: 파일명 = 사용자가 정한 제목 그대로 (`[[테니스 이너 게임]]`, `[[Devil Wears Prada 2]]`).
...
- 개념 후보 추출 → **고아 정책 통과분만** Concept로 승격(2 Work+ 또는 2 Concept 연결). 미달은 인라인 태그(비링크 문자열)로만 남긴다.
...
6. Cross-book: `ai_connected_works` 양방향 + `index.md` 갱신
